...
export const timelineItems: TimelineItem[] = [
  {
    ...
    year: 2026,
    title: 'Actualmente',
    description: 'Clases particulares y para grupos de principiantes.',
    order: 1,
  },
  {
    _id: 't2',
    ...
    year: 2025,
    title: 'Estilos',
    description: 'Especialización en Vinyasa y Hatha yoga.',
    order: 2,
  },
  {
    _id: 't3',
    ...
    description: '+400 horas de formaciones, cursos, talleres e investigación.',
    order: 3,
  },
  {
    _id: 't4',
    ...
    description: 'Jornadas Diseño y Secuenciación Instituto de Yoga.',
    order: 4,
  },
    {
    _id: 't5',
    category: 'yoga',
    year: 2023,
    title: 'Titulación profesora de yoga',
    description: 'Certificación 200h RYT Yoga Alliance.',
    order: 4,
  },
    {
    _id: 't6',
    ...
    description: '6 años practicando diferentes estilos (Vinyasa, Ashtanga, Yin yoga).',
    order: 4,
  },
  {
    _id: 't5',
